...
export function handleApiError(
  ...
  let statusCode = 500;
  let message = 'A apărut o eroare internă'; // Romanian UI message
...
export const ErrorFactory = {
  badRequest: (message: string = 'Cerere invalidă') =>
  ...
  notFound: (message: string = 'Resursa nu a fost găsită') =>
  ...
  internalError: (message: string = 'Eroare internă de server') =>
