// ============================================================
// S-S-M.RO — Training Dashboard Page
...
// Option B: Get from auth context (better)
// import { useAuth } from '@/lib/auth'; // if you have auth context
// const { user } = useAuth();
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const [modulesData, dashboardData, statsData, workerStatusData, workersData] = await Promise.all([
        getTrainingModules(),
        getTrainingDashboard(ORGANIZATION_ID, {
          status: filterStatus || undefined,
          category: filterCategory || undefined,
        }),
        getTrainingStats(ORGANIZATION_ID),
        getWorkerStatuses(ORGANIZATION_ID),
        getOrganizationWorkers(ORGANIZATION_ID),
      ]);
