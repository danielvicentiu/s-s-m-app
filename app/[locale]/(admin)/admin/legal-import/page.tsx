...
function parseLegalText(raw: string): FormattedSegment[] {
  ...
  let text = raw
    ...
    .replace(/(?<=[a-zăâîșțA-ZĂÂÎȘȚ.;:)"0-9])(Articolul\s+\d+)(?=[^0-9])/gi, '\n\n$1\n')
    .replace(/(?<=[a-zăâîșțA-ZĂÂÎȘȚ.;:)"0-9])(Articolul\s+[IVXLCDM]+)(?=[^IVXLCDM])/gi, '\n\n$1\n')
    .replace(/(?<=[a-zăâîșțA-ZĂÂÎȘȚ.;:)"0-9])(Art\.\s*\d+)(?=[^0-9])/gi, '\n\n$1\n')
    .replace(/(?<=[a-zăâîșțA-ZĂÂÎȘȚ.;:)"0-9])(Art\.\s*[IVXLCDM]+)(?=[^IVXLCDM])/gi, '\n\n$1\n')
