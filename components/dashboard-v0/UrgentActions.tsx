...
const actions = [
  { title: 'Fișa SSM - Departament Logistică', detail: 'Expiră în 2 zile', priority: 'red' as const },
  { title: 'Instruire PSI - Echipa Producție', detail: 'Termen depășit cu 3 zile', priority: 'red' as const },
