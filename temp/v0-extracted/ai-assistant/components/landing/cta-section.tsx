...
export function CtaSection() {
  ...
  return (
    <section
      id="cta"
      className="bg-background px-6 py-20 lg:py-28"
    >
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-balance text-3xl font-extrabold tracking-tight text-foreground md:text-4xl">
          {"Începe astăzi — primele 30 de zile gratuit"}
        </h2>
        <p className="mt-4 text-pretty text-lg leading-relaxed text-muted-foreground">
          {"Fără card de credit. Fără obligații. Configurează-ți contul în mai puțin de 2 minute."}
        </p>
        <form
